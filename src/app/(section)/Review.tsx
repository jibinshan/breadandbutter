    ...
    <section className="relative flex h-full w-full justify-center bg-[#FFF6EB] pb-8 lg:pb-0">
      <div className="flex h-full w-full max-w-[1300px] flex-col items-start justify-center gap-4 py-12 md:py-44 md:pt-24">
        <div className="flex h-full w-full flex-col items-center justify-center gap-2 lg:gap-4">
          <h1 className="font-oswald text-center text-5xl font-[400] uppercase text-[#0D0D0D] lg:text-8xl lg:leading-[100px]">
            testimonial
          </h1>
          <Image
                ...
                {reviews.map((review, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-4">
                      <p className="font-cormorant line-clamp-6 text-sm font-[500] uppercase text-[#000] lg:leading-[120%]">
                        {review.text}
                      </p>
